...
/* ---------- Helper ---------- */
const getFollowMax = (theme) => Math.max(theme?.followMessage?.length ?? 0, 1);
const getRedeemMax = (theme) => Math.max(theme?.redeemMessage?.length ?? 0, 1);

/**
 * ChatMessageList - Reusable component for rendering chat messages
 *
...
export default function ChatMessageList({
    ...
    const [showSourceChannel, setShowSourceChannel] = useState(false);
                    ...
                    <TransitionGroup component={null}>
                        {messages.map((msg, idx) => {
                            ...
                            if (msg.type === 'chat') {
                                ...
                                Content = <ChatRedemption message={msg} currentTheme={theme} index={redemptionIndex} />;
                            } else {
                                return null;
                            }
