    ...
    translation: {
        ...
        settings: {
            ...
            pages: {
                ...
                obsActions: { title: 'OBS Actions', label: 'OBS' },
                httpActions: { title: 'HTTP Requests', label: 'HTTP' },
                ...
                mediaOverlay: { label: 'Media Overlay' },
            },
            general: {
                appearance: {
                    title: 'Appearance',
            ...
            bot: {
                ...
                triggers: {
                    ...
                    mediaEvent: {
                        selectEvent: 'Media event',
                        selectEventPlaceholder: 'Choose a media event...',
                        edit: 'Edit',
                        create: 'Create',
                        editTitle: 'Edit Media Event',
                        createTitle: 'New Media Event',
                        ...
                        displayDuration: 'Display duration (sec)',
                        displayGroup: 'Display group',
                        noGroups: 'No groups available',
                        caption: 'Caption',
                        captionTemplate: 'Caption text',
                        captionPlaceholder: '${user} just did something amazing!',
            ...
            chatMessages: {
                ...
                badgeOverride: {
                    ...
                    sourceOptions: {
                        twitch: 'Twitch only',
                        custom: 'Custom (Twitch fallback)',
                    },
                    multipleTitle: 'Badge count',
                    multipleOptions: {
                        all: 'All',
                        first: 'Highest priority only',
                        overriddenOnly: 'Overridden only',
                    },
                    priorityTitle: 'Priority order (top wins)',
                    customIconsTitle: 'Custom icons',
                    pickThemeHint: 'Select a theme to upload icons.',
                    moveUp: 'Move up',
                    moveDown: 'Move down',
                    upload: 'Upload',
                    replace: 'Replace',
                    removeIcon: 'Remove icon',
                    userListPlaceholder: 'login1, login2 — or one per line',
                    editorHint: 'Twitch has no editor chat badge — the role is assigned only via the login list.',
                    artistHint: 'In addition to the channel Twitch artist-badge, you can list logins manually.',
                    roles: {
            ...
            obsActions: {
                ...
                operations: {
                    ...
                    virtualcam_control: 'Virtual camera control',
                    media_control: 'Media source control',
                },
                modes: {
                    on: 'On',
                    off: 'Off',
                ...
                editor: {
                    nameLabel: 'Name',
                    namePlaceholder: 'e.g. Switch to BRB',
                    ...
                    save: 'Save',
                    cancel: 'Cancel',
                    fallbackManualInput: 'OBS not connected — enter manually',
                },
                empty: {
                    title: 'No OBS actions found',
                    description: 'Create your first action to use it in triggers',
            ...
            httpActions: {
                ...
                editor: {
                    nameLabel: 'Name',
                    namePlaceholder: 'e.g. Discord webhook — !so',
                    methodLabel: 'Method',
                    urlLabel: 'URL',
                    urlPlaceholder: 'https://example.com/webhook',
                    urlHint: 'Supports ${user}, ${target}, ${args[N]}, ${reward}, ${raider}, ${viewers}.',
                    headersLabel: 'Headers',
                    headerNamePlaceholder: 'Header name',
                    headerValuePlaceholder: 'Value',
                    headerSecretPlaceholder: 'Saved (enter to replace)',
                    addHeader: 'Add header',
                    secretToggle: 'Secret',
                    secretHint: 'Stored in the OS keychain, never written to the config file.',
                    bodyLabel: 'Body',
                    bodyContentPlaceholder: '{"text": "${user} triggered"}',
                    timeoutLabel: 'Timeout (ms)',
                    save: 'Save',
                    cancel: 'Cancel',
                    test: 'Test',
                    testRunning: 'Sending…',
                    testSuccess: 'OK — HTTP {{status}} in {{ms}}ms',
                    testFailure: 'Failed: {{error}}',
                },
                empty: {
                    title: 'No HTTP requests yet',
                    description: 'Create your first request to use it in triggers',
                    noResults: 'Nothing found',
                ...
                confirmDelete: {
                    ...
                    message: 'Are you sure you want to delete "{{name}}"?',
                    warning: 'Deletion cannot be undone. The request may be used in triggers. Stored secrets will also be erased.',
                },
            },
            mediaEvents: {
                searchPlaceholder: 'Search by name...',
        ...
        mediaOverlay: {
            ...
            noGroups: 'No display groups',
            noGroupsHint: 'Create a group to start',
            ...
            stackGap: 'Gap (px)',
            stackWrap: 'Wrap',
            wrapEnabled: 'Wrap to next line',
            wrapDisabled: 'Overflow',
            animation: 'Animation',
            animIn: 'In',
            animOut: 'Out',
            inDuration: 'In (ms)',
